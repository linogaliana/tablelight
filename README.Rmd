...
Let's say you want to produce a regression table from two objects. For the moment, the freedom in customizing the table is limited. 
...
2. Use `light_table` to produce the output. You should give objects as a list
